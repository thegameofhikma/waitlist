    ...
    <div className="relative z-10 max-w-4xl mx-auto px-6 text-center space-y-8 flex flex-col items-center py-20">
      ...
      <div className="pt-4">
        <Button
          ...
          size="lg"
          className="h-14 px-8 text-lg rounded-full bg-[#6a332d] hover:bg-[#6A32D3] text-primary-foreground transition-all duration-300 hover:scale-105 shadow-lg shadow-primary/30"
          onClick={() => {
